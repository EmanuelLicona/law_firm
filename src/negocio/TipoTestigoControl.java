 ...
 * @author Buddys
 */
public class TipoTestigoControl {

    private final TipoTestigoDAO DATOS;
    private TipoTestigo objeto;
    private DefaultTableModel modeloTabla;
    public int registrosMostrados;
    private String respuesta;

    public TipoTestigoControl() {
        this.DATOS = new TipoTestigoDAO();
        this.objeto = new TipoTestigo();
